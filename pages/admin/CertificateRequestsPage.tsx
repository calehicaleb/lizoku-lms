                ...
                <div className="overflow-x-auto">
                    <table className="min-w-full text-sm">
                        <thead className="bg-gray-50">
                            <tr>
                                ...
                                <th className="px-4 py-2 text-left font-medium text-gray-500">Request Date</th>
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {requests.map(req => (
                                <tr key={req.id}>
                                    <td className="px-4 py-3 whitespace-nowrap font-medium text-gray-900">{req.studentName}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-gray-500">{req.courseName}</td>
                                    <td className="px-4 py-3 whitespace-nowrap text-gray-500">{new Date(req.requestDate).toLocaleString()}</td>
                    ...
                    {requests.length === 0 && (
                        <div className="text-center py-16 px-6">
                            ...
                            <p className="mt-1 text-sm text-gray-500">There are no pending certificate requests to review.</p>
                        </div>
                    )}
                </div>
            </div>
